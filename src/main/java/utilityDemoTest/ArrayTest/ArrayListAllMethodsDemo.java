...
public class ArrayListAllMethodsDemo {
    public static void main(String[] args) {
        ...
        list.add("Java");// 1. Add elements
        list.add("Python");
        list.add("C++");
        System.out.println("After add: " + list);
        list.add(1, "Go");// 2. Add at index
        System.out.println("After add at index: " + list);
        list.addAll(Arrays.asList("Rust", "Kotlin")); // 3. AddAll
        System.out.println("After addAll: " + list);// 4. Get element
